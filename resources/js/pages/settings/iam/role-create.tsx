...
import { buildPermissionModules, fromGridIds } from '@omnify-core/utils/scope-utils';
...
export default function IamRoleCreate({ all_permissions }: Props) {
    ...
    const mutation = useFormMutation({
        form,
        mutationFn: (data: RolePayload) => api.post(`${iamBase}/roles`, data),
        redirectTo: `${iamBase}/roles`,
        onError: (error) => {
