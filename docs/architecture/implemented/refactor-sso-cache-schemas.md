...
- [ ] `CoreServiceProvider.php` - Update model bindings
- [ ] `Providers/CoreServiceProvider.php` - Update model bindings
...
class_alias(\Omnify\Core\Models\Branch::class, 'Omnify\Core\Models\Branch');
class_alias(\Omnify\Core\Models\User::class, 'Omnify\Core\Models\User');
class_alias(\Omnify\Core\Models\Team::class, 'Omnify\Core\Models\Team');
```
...
class User extends \Omnify\Core\Models\User
{
    // ...
}
