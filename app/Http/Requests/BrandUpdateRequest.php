...
use App\Http\Requests\OmnifyBase\BrandUpdateRequestBase;

/**
 * BrandUpdateRequest — add project-specific authorization and validation here.
 *
 * Inherited from base:
 ...
 */
class BrandUpdateRequest extends BrandUpdateRequestBase
{
    //
}
